...
export const navItems = [
  ...
  { label: 'CRM', header: true, roles: ['admin', 'hr', 'employee'] },
  ...
  { path: '/automation', name: 'Automation', icon: 'automation', roles: ['admin', 'hr'] },
  { divider: true, roles: ['admin', 'hr', 'employee'] },
  { label: 'Leave', header: true, roles: ['admin', 'hr', 'employee'] },
  ...
  { path: '/reports', name: 'Leave Reports', icon: 'chart', roles: ['admin', 'hr'] },
  { divider: true, roles: ['admin', 'hr'] },
  { label: 'Management', header: true, roles: ['admin', 'hr'] },
  { path: '/employees', name: 'Employee Management', icon: 'users', roles: ['admin', 'hr'] },
  { path: '/users', name: 'User Management', icon: 'user-cog', roles: ['admin', 'hr'] },
  { path: '/settings', name: 'System Settings', icon: 'settings', roles: ['admin', 'hr'] },
  { path: '/audit-logs', name: 'Audit Logs', icon: 'audit', roles: ['admin', 'hr'] },
  { divider: true, roles: ['admin', 'hr', 'employee'] },
